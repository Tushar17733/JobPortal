...
export const MESSAGING_API_ENDPOINT = "https://jobportal-y1np.onrender.com/api/v1/messaging"
...
// export const MESSAGING_API_ENDPOINT = "http://localhost:8000/api/v1/messaging";
