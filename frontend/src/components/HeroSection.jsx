  ...
  return (
     <div className='text-center px-4 sm:px-6 lg:px-8'>
            <div className='flex flex-col gap-4 sm:gap-5 my-6 sm:my-8 lg:my-10'>
                <span className='mx-auto px-3 sm:px-4 py-1 sm:py-2 rounded-full bg-gray-100 text-[#F83002] font-medium text-sm sm:text-base'>No. 1 Job Hunt Website</span>
                ...
                <div className='flex w-full sm:w-[80%] md:w-[60%] lg:w-[40%] shadow-lg border border-gray-200 pl-3 rounded-full items-center gap-2 sm:gap-4 mx-auto'>
                    ...
                    />
                    <Button className="rounded-r-full bg-[#6A38C2] cursor-pointer px-3 sm:px-4 py-2 sm:py-3">
