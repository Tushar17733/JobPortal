...
export default function AdminMessages() {
    ...
    // Fetch conversations for recruiter
    useEffect(() => {
                ...
                <div className="max-w-4xl mx-auto mt-8 px-4">
                    <Card>
                        <CardContent className="p-8 text-center">
                            ...
                            <p className="text-gray-600">Only recruiters can access this page.</p>
                        </CardContent>
                    </Card>
                </div>
            </div>
    ...
    return (
        <div>
            ...
            <div className="max-w-6xl mx-auto mt-8 px-4">
                <h1 className="text-2xl font-bold mb-6">Recruiter Messages</h1>
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <p className="font-medium truncate">
                                                            {conversation.participants.find(p => p._id !== user._id)?.fullName || 'Candidate'}
                                                        </p>
                            ...
                            <Card className="h-[600px] flex flex-col">
                                <CardHeader className="border-b">
                                    <CardTitle className="flex items-center gap-2">
                                        ...
                                        {selectedConversation.participants.find(p => p._id !== user._id)?.fullName || 'Candidate'}
