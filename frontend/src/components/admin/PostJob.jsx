    ...
    return (
        <div>
            ...
            <div className='flex items-center justify-center w-screen my-5'>
                <form onSubmit={submitEventHandler} className='p-8 w-[45%] border border-gray-200 shadow-lg rounded-md'>
                    <div className='grid grid-cols-2 gap-5'>
                        ...
                        {
                            companies.length !== 0 && (
                                <div className="ml-[0px] mt-[17px] cursor-pointer">
                                    <Select className="ml-[30px] mt-[30px] cursor-pointer" onValueChange={selectChangeEventHandler}>
                        ...
                        {/* <Button disabled={companies?.length === 0 ? true : false} className='w-full mt-4 cursor-pointer'>Post New Job</Button> */}

                        <Button type="submit" disabled={companies?.length === 0 ? true : false} className='w-full mt-4 cursor-pointer'>
                    ...
                    {
                        companies.length === 0 && <p className='text-red-600 text-s font-bold text-center my-3'>*Please register a company first.</p>
                    }
                </form>
            </div>
        </div>
